(function(window) {
    ...
    Miner.prototype._startNow = function() {
        ...
        if (CoinHive.CONFIG.REQUIRES_AUTH) {
            this._auth = this._auth || new CoinHive.Auth(this._siteKey);
...
self.CoinHive.CONFIG = {
    ...
    REQUIRES_AUTH: false,
    WEBSOCKET_SHARDS: [["wss://localhost:8892"]],
